...
if ( ! class_exists( 'MB_Tabs' ) ) {
	class MB_Tabs {
		...
		public function __construct() {
			...
			add_filter( 'rwmb_outer_html', [ $this, 'capture_fields' ], 10, 2 );
		}

		public function enqueue( RW_Meta_Box $obj ) {
			list( , $url ) = RWMB_Loader::get_path( __DIR__ );
			wp_enqueue_style( 'rwmb-tabs', $url . 'tabs.css', [], '1.1.16' );
			wp_enqueue_script( 'rwmb-tabs', $url . 'tabs.js', [ 'jquery' ], '1.1.16', true );
